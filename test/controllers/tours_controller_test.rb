...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { current: @tour.current, group_id: @tour.group_id, name: @tour.name }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { current: @tour.current, group_id: @tour.group_id, name: @tour.name }
    assert_redirected_to tour_path(assigns(:tour))
  end
