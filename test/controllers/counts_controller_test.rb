...
class CountsControllerTest < ActionController::TestCase
  ...
  test "should create count" do
    assert_difference('Count.count') do
      post :create, count: { in: @count.in, item_id: @count.item_id, out: @count.out, show_id: @count.show_id }
    end
  ...
  test "should update count" do
    patch :update, id: @count, count: { in: @count.in, item_id: @count.item_id, out: @count.out, show_id: @count.show_id }
    assert_redirected_to count_path(assigns(:count))
  end
